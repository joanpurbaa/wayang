// src/data/sejarahWayang.ts

export interface EraData {
  id: string;
  nomor: string; // "I", "II", dst — atau "01"/"02" kalau mau numeric
  judul: string;
  periode: string;
  image: string;
  warna: string; // hex accent color per era
  r: number;
  g: number;
  b: number;
  narasi: string; // paragraf utama
  detail: string[]; // 2-3 poin penting, bukan paragraf panjang
  quote?: string; // optional pull-quote kecil
}
...
export const SEJARAH_WAYANG: EraData[] = [
  {
    ...
    quote: "Wayang lahir dari kegelapan api unggun, jauh sebelum ia menjadi seni.",
  },
  {
    id: "hindu-buddha",
    nomor: "II",
  ...
  },
  {
    ...
    quote: "Warisan sejati bukan yang disimpan di museum, melainkan yang diturunkan ke tangan berikutnya.",
  },
];